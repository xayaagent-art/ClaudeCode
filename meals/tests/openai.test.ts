...
const CONCEPTS = [
  ...
  },
  {
    ...
    meal_format: "curry",
    protein_source: "chickpea",
    flavor_profile: "indian-spiced",
    instructions: ["Soften the onions.", "Add the chickpeas and tomato.", "Simmer and serve."],
    ingredient_quantities: ["400 g", "1 tsp"],
  ...
  },
  {
    ...
    meal_format: "salad",
    protein_source: "chickpea",
    flavor_profile: "mediterranean",
    instructions: ["Chop the cucumber.", "Toss with chickpeas and feta.", "Dress and serve."],
    ingredient_quantities: ["400 g", "2 tbsp"],
